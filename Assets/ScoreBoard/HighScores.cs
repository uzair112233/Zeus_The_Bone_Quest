...
{
    const string privateCode = "v0OifE65hkWF2JFuYsVpqgmSI83BQ4i0eW1uYbjRTHoA";  //Key to Upload New Info
    const string publicCode = "6138bc8a8f40bb6e98d288de";   //Key to download
